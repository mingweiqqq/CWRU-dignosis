...
2. Vibration signals generated by rolling bearing failures typically exhibit nonlinear and non-stationary characteristics. Compared to conventional time-domain and frequency-domain approaches, time-frequency analysis methods are more effective in processing these complex signals. One-dimensional fault data is transformed into  two-dimensional images for classification.
## Acknowledgment
This code is built on [CWRU](https://github.com/XiongMeijing/CWRU-1). We thank the authors for sharing their codes.
